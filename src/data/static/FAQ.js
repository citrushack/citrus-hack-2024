export const QUESTIONS = [
  ...
  },
  {
    ...
    answer:
      "The event will be at the University of California, Riverside and will primarily take place in Winston Chung Hall! With some events taking place in the Material Science and Engineering Building.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We will have team building and formation opportunties right after opening ceremony for individuals to create teams! You can also reach out to other hackers in the Discord to create your team!",
  },
  {
    question: "Do I have to hack or make a project?",
    answer:
      "No! You are not required to submit a project or hack. You can just come out to the events and workshops to explore.",
  },
  {
    question: "Where will I submit?",
    answer:
      "You will be submitting via Devpost, we will be sending more information within Discord!",
  },
];
